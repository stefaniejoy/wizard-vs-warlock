public class App {
    public static void main(String[] args) throws Exception {
         ...
         */
        Wizard Stefanie = new Wizard("Stefanie");
        Warlock Arnel = new Warlock("Arnel");

        System.out.println("\nLet the Fight begin ");

            System.out.println("\nMerlin's Turn\n");
            Arnel.Poison(Stefanie);//Stefanie HP Deducted

            //Displaying the Opponent stats
            System.out.println("\nDisplaying Opponent stats: ");
            Stefanie.displayStatus();


            System.out.println("\nStefanie's Turn\n");
            Stefanie.fireStorm(Arnel);//Stefanie HP Deducted
            ...
            System.out.println("\nArnel's Turn\n");
            Arnel.healthRejuvenation(); //Regenerating 10% for Stefanie 

            //Displaying the Stats
           Arnel.displayStatus();

            System.out.println("\nStefanie's Turn\n");
           Stefanie.fireStorm(Arnel);//Damages Arnel (-40 Health) --Arnel has been Defeated
           ...
           Arnel.displayStatus();
            ...
            System.out.println("\nArnel's Turn\n");
            Arnel.Poison(Stefanie);//Damages Stefanie (-40 Health)
